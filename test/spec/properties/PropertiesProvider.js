...
function createGroups(element, cmmnFactory) {
        ...
        entries: [
          ...
          },
          {
            ...
            set: function(element, values) {
              ...
              var docs = cmmnFactory.create('cmmn:Documentation', { text: values.documentation });
...
function PropertiesProvider(eventBus, cmmnFactory) {
