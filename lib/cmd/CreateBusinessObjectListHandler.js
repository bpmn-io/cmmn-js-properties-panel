 ...
 * @constructor
 */
function CreateBusinessObjectListHandler(cmmnFactory) {
  this._cmmnFactory = cmmnFactory;
}

CreateBusinessObjectListHandler.$inject = [ 'cmmnFactory' ];
...
CreateBusinessObjectListHandler.prototype.execute = function(context) {
  ...
  forEach(newObjects, function(obj) {
    var element = elementHelper.createElement(obj.type, obj.properties, currentObject, self._cmmnFactory);
