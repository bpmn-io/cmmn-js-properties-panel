...
function createGeneralTabGroups(element, cmmnFactory, elementRegistry, itemRegistry, cmmnRules) {
  ...
  onPartProps(detailsGroup, element, cmmnFactory, elementRegistry, itemRegistry, cmmnRules);
  ifPartProps(detailsGroup, element, cmmnFactory, elementRegistry, itemRegistry, cmmnRules);
  humanTaskProps(detailsGroup, element, cmmnFactory, elementRegistry, itemRegistry, cmmnRules);
