...
module.exports = function(element, cmmnFactory, itemRegistry, translate, options) {
  ...
  return ConditionProp(element, cmmnFactory, translate, {

    id: id || 'rule',
    label: label || translate('Rule'),
    reference: reference,
