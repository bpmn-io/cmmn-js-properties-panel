...
module.exports = function(group, element, cmmnFactory, elementRegistry, itemRegistry, cmmnRules, translate, options) {
  ...
  function validateRule(prop) {
    ...
    return function(element, values, node, definition) {
      ...
      if (itemRule && defaultRule) {
        result[prop] = { warning: translate('Rule is overwritten by item control') };
      }
  ...
  if (cmmnRules.canSetManualActivationRule(element)) {
    ...
    group.entries = group.entries.concat(RuleProp(element, cmmnFactory, itemRegistry, translate, {

      id: idPrefix + 'ManualActivationRule',
      label: translate('Manual Activation Rule'),
      reference: reference,
  ...
  if (cmmnRules.canSetRepetitionRule(element)) {
    ...
    group.entries = group.entries.concat(RuleProp(element, cmmnFactory, itemRegistry, translate, {
      ...
      label: translate('Repetition Rule'),
      reference: reference,
      controlRef: controlRef,
