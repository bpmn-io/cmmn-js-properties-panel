...
ExtensionElementsHelper.addEntry = function(bo, element, entry, cmmnFactory) {
  var extensionElements = bo.get('extensionElements');

  // if there is no extensionElements list, create one
  if (!extensionElements) {
    // TODO: Ask Daniel which operation costs more
    extensionElements = elementHelper.createElement('cmmn:ExtensionElements', { values: [entry] }, bo, cmmnFactory);
