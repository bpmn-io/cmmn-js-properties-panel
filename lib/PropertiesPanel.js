...
PropertiesPanel.prototype.activateTab = function(tab) {
  ...
  var allTabNodes = domQuery.all('.cpp-properties-tab', panelNode),
      allTabLinkNodes = domQuery.all('.cpp-properties-tab-link', panelNode);
...
PropertiesPanel.prototype._createPanel = function(element, tabs) {
  ...
  forEach(tabs, function(tab, tabIndex) {
    ...
    var tabNode = domify('<div class="cpp-properties-tab" data-tab="' + tab.id + '"></div>'),
    ...
    forEach(groups, function(group) {
      ...
      var groupNode = domify('<div class="cpp-properties-group" data-group="' + group.id + '">' +
      ...
      forEach(group.entries, function(entry) {
        ...
        var entryNode = domify('<div class="cpp-properties-entry" data-entry="' + entry.id + '"></div>');
